...
function Table({ className, ...props }: React.ComponentProps<'table'>) {
  return (
    <div
      ...
      // El overflow-x-auto permite el scroll horizontal solo si es necesario
      // Usamos rounded-xl para una mejor estética
      className="relative w-full overflow-x-auto rounded-xl border border-border bg-card shadow-sm"
    >
      <table
        data-slot="table"
        // 'w-full' asegura que la tabla ocupe el ancho disponible
